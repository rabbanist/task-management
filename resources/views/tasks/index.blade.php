                                ...
                                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"
                                                class="px-3 py-3.5 text-left text-sm font-semibold dark:text-white">Assign To
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-3.5 text-left text-sm font-semibold dark:text-white">Status
                                            </th>
...
{{--                                            <tr>--}}
{{--                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium dark:text-white sm:pl-0">{{$task->name}}</td>--}}
{{--                                                <td class="whitespace-nowrap px-3 py-4 text-sm dark:text-white">{{$task->}}</td>--}}
{{--                                                <td class="whitespace-nowrap px-3 py-4 text-sm dark:text-white">{{$task->email}}</td>--}}
{{--                                                <td class="whitespace-nowrap px-3 py-4 text-sm dark:text-white">{{$task->email}}</td>--}}
