                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 dark:text-white">Task Create</h1>
                        </div>
                    ...
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" name="description" class="block mt-1 w-full dark:bg-gray-800 text-white" rows="3">{{old('description')}}</textarea>
