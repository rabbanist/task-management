                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 dark:text-white">Project Edit</h1>
                            </div>
                        ...
                        <form method="POST" action="{{ route('projects.update',$project) }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" class="block mt-1 w-full" type="text" name="name"
                                              value="{{ $project->name }}"  autofocus autocomplete="name"/>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="project_code" class="block mt-1 w-full" type="text" name="project_code"
                                              value="{{ $project->project_code }}"  autofocus autocomplete="project_code"/>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="manager_id" class="block mt-1 w-full" type="text" name="manager_id"
                                              value="{{ auth()->user()->id }}"  autofocus autocomplete="manager_id"/>
